...
export function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed right-4 bottom-4 z-40 flex items-center gap-2 bg-[#1f6b45] px-4 py-3 text-xs font-medium tracking-[0.14em] text-white uppercase shadow-lg transition hover:bg-[#185536] sm:right-6 sm:bottom-6"
    >
